 ...
 */
public class CartFab extends FloatingActionButton {

    private final Property<CartFab, Float> ANIMATION_PROPERTY =
            new Property<CartFab, Float>(Float.class, "animation") {

                @Override
                public void set(CartFab object, Float value) {
                    mAnimationFactor = value;
                    postInvalidateOnAnimation();
                }

                @Override
                public Float get(CartFab object) {
                    return 0f;
                }
            };
    ...
    public CartFab(Context context) {
        this(context, null, 0);
    }

    public CartFab(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CartFab(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link CartFab#onSaveInstanceState()}
         */
        ...
        public String toString() {
            return CartFab.class.getSimpleName() + "." + SavedState.class.getSimpleName() + "{"
