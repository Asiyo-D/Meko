...
import utils.location.permission.PermissionControl;
import utils.location.playservices.PlayServiceAvailability;
...
public class GetCurrentLocation implements LocationListener,
    ...
    public void getCurrentLocation() {
        ...
        if (permissionControl.getOnlyLocationPermission(activity)) {
            getLocation();
        }
    }
